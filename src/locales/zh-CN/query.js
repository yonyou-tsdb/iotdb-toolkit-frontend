export default {
  ...
  'query.sql.tooltip1': 'SQL输入框聚焦时可使用以下热键：',
  'query.sql.tooltip2': '(1) 执行SQL：F8',
  'query.sql.tooltip3': '(2) 格式化SQL：Shift+(Ctrl 或 Cmd)+F',
  'query.sql.tooltip4': '(3) 注释：(Ctrl 或 Cmd)+/',
  'query.sql.tooltip5': '(4) 可以只执行鼠标选中的部分',
  'query.query.text': '查询',
